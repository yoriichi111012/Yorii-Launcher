...
public sealed partial class ThemesMarketplace : Page
{
    ...
    private async Task LoadCatalogAsync()
    {
        ...
        try
        {
            ...
            // new preview session: re-enable preview loading for items that
            // were never realized or whose previous request was cancelled
    ...
    private static HashSet<string> GetInstalledThemeNames()
    {
        ...
        try
        {
            ...
            {
                var themeFile = Path.Combine(dir, "theme.yaml");
    ...
    private void ThemeList_ContainerContentChanging(ListViewBase sender, ContainerContentChangingEventArgs args)
    {
        ...
        // load the preview only for items actually realized on screen
    ...
    private void ApplyFilter(string query)
    {
        ...
        foreach (var entry in filtered)
        {
            ...
            // reuse existing item so already-loaded previews survive filtering
