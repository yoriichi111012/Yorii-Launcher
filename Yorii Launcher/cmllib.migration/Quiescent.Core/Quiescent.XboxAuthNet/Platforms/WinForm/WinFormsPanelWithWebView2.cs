...
namespace Quiescent.XboxAuthNet.Platforms.WinForm;
...
internal class WinFormsPanelWithWebView2 : Form
{
    ...
    private void InitializeComponent()
    {
        InvokeHandlingOwnerWindow(() =>
        {
            ...
            // PrimaryScreen can be null on headless/RDP sessions; fall back to
            // a sane default instead of throwing NullReferenceException.
            int workingHeight = screen?.WorkingArea.Height ?? 900;
            // Window height is set to 70% of the screen height.
            int uiHeight = (int)(Math.Max(workingHeight, 160) * 70.0 / WindowsDpiHelper.ZoomPercent);
