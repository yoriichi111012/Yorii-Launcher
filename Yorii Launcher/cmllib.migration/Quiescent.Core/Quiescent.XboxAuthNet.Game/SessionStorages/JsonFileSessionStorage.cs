...
namespace Quiescent.XboxAuthNet.Game.SessionStorages
{
    ...
    // new JsonSerializerOptions() instead of JsonSerializerOptions.Default:
    // same defaults, but Default carries RequiresUnreferencedCode /
    // RequiresDynamicCode annotations (IL2026/IL3050 under trimming/AOT).
    public JsonFileSessionStorage(string filePath) : this(filePath, new JsonSerializerOptions()) {}
