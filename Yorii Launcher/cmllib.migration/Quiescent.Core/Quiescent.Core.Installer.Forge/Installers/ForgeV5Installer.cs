...
using Quiescent.Utils;
using ICSharpCode.SharpZipLib.Zip;

namespace Quiescent.Core.Installer.Forge.Installers;
...
public class ForgeV5Installer : IForgeInstaller
{
    ...
    private async Task writeVersionJson(MinecraftPath path, JsonElement version)
    {
        ...
        await Quiescent.Core.Commons.Serialization.QuiescentJson.SerializeAsync(versionJsonStream, version);
    }
}