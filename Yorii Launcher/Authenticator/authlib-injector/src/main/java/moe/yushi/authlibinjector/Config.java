...
public final class Config {
	...
	// shared index of all YoriiSkins profiles (public repo); entries with
	// kind "public" are served by the legacy skins.minecraft.net API, private
	// profiles resolve through the upstream Yggdrasil path instead
	public static /* nullable */ String githubSkinIndexUrl =
			"https://raw.githubusercontent.com/yorii-accounts/yorii-skins/main/index.json";
	...
	static void init() {
		...
		String skinIndexProp = System.getProperty("authlibinjector.github.skinIndexUrl");
		if (skinIndexProp != null && !skinIndexProp.isEmpty()) {
			githubSkinIndexUrl = skinIndexProp;
			log(INFO, "GitHub skin index URL: " + githubSkinIndexUrl);
		}
	}
}
